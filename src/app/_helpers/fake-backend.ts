...
const usersKey = 'angular-10-signup-verification-boilerplate-users';
...
export class FakeBackendInterceptor implements HttpInterceptor {
  ...
  intercept(
    ...
    function validateResetToken(): any {
      const { token } = body;
      const user = users.find(
        (x) =>
          !!x.resetToken &&
    ...
    function generateRefreshToken(): any {
